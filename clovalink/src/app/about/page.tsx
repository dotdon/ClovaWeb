              ...
              <div className="mt-10 lg:mt-0">
                <div className="bg-blue-50 dark:bg-slate-800 rounded-lg p-8">
                  <div className="text-center max-w-md mx-auto">
                    ...
                    <div className="mt-4">
                      <a href="https://github.com/dotdon/clovalink" className="text-blue-600 hover:text-blue-500 inline-flex items-center" target="_blank" rel="noopener noreferrer">
            ...
            <div className="mt-20 bg-blue-50 dark:bg-slate-800 rounded-lg p-8">
              <div className="text-center">
                ...
                <div className="mt-8 flex justify-center space-x-6">
                  <a href="https://github.com/dotdon/clovalink" className="text-blue-600 hover:text-blue-500" target="_blank" rel="noopener noreferrer">
